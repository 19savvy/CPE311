    ...
    for (int i = 0; i < numOfPlayers; i++)
    {
        ...
        for (int j = 0; j < (numOfPlayers == 4 ? 1 : 2); j++)
        {
            do
            {
                ...
                if (color_string == "Red" || color_string == "red" || color_string == "RED")
                {
                    chosen_color = Color::RED;
                    exists = true;
                }
                else if (color_string == "Green" || color_string == "green" || color_string == "GREEN")
                {
                    chosen_color = Color::GREEN;
                    exists = true;
                }
                else if (color_string == "Yellow" || color_string == "yellow" || color_string == "YELLOW")
                {
                    chosen_color = Color::YELLOW;
                    exists = true;
                }
                else if (color_string == "Blue" || color_string == "blue" || color_string == "BLUE")
                {
